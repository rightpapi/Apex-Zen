...
All values, mods, and settings submitted to this repository must be formatted using Markdown code blocks to ensure consistency and readability. Contributions that are not properly formatted may be removed until they have been corrected.

All values and content within this repository are public. You are welcome to use them for personal purposes; however, if you redistribute, reupload, or feature any part of this repository in videos, streams, social media, or other public content, you must provide clear credit by linking back to this repository.

Do not claim any values, settings, or other content from this repository as your own work. If you modify existing content before sharing it elsewhere, please make it clear that your version has been altered.
